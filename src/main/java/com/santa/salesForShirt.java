...
public class salesForShirt {
    public static void main(String[] args) {
        ...
        double procentOfSkidka = costOfSalesShirt/(costOfShirt*(countForSales+countForSales));
        double saveMany = countOfSalesForShirt+costOfShirt*countForSales-costOfSalesShirt;
        System.out.println("saveMany = " + saveMany);

        System.out.println("procentOfSkidka = " + procentOfSkidka);
    }
}
